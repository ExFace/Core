...
class DataSheet implements DataSheetInterface {
	...
	public function __construct(\exface\Core\Model\Object &$meta_object){
	 ...
	 * @param \exface\Core\QueryBuilder\AbstractQueryBuilder $query
	 */
	protected function get_data_for_column(DataColumnInterface $col, \exface\Core\QueryBuilder\AbstractQueryBuilder &$query){
