...
FROM exf_user u
	...
	LEFT JOIN exf_auth_policy apol ON 
		apol.target_user_role_oid = uru.user_role_oid 
		OR apol.target_user_role_oid IS NULL 
		OR (apol.target_user_role_oid = 0x11ea6fa3cab9a380a3480205857feb80 AND u.oid != 0x00000000000000000000000000000000)
