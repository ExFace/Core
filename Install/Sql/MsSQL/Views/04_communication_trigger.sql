IF OBJECT_ID('dbo.exf_communication_trigger', 'V') IS NOT NULL
    DROP VIEW [dbo].[exf_communication_trigger];
GO
CREATE VIEW [dbo].[exf_communication_trigger] (
   [communication_template_oid], 
   [object_behavior_oid], 
   [object_action_oid], 
   [object_oid], 
   [name],
