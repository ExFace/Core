...
SELECT
    ...
    apol.oid AS authorization_policy_oid
FROM exf_user u
         LEFT JOIN exf_auth_policy apol ON apol.target_user_role_oid IS NULL OR (apol.target_user_role_oid = '11ea6fa3cab9a380a3480205857feb80' AND u.oid != '00000000000000000000000000000000')
         INNER JOIN exf_auth_point apt ON apol.auth_point_oid = apt.oid
WHERE
    apt.target_user_role_applicable = 1