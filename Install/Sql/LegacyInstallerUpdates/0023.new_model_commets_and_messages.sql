...
ALTER TABLE `exf_error` 
	ADD `hint` VARCHAR(250) NULL AFTER `error_text`,
	ADD `type` VARCHAR(10) NOT NULL DEFAULT 'ERROR' AFTER `description`, 
	ADD `docs_path` VARCHAR(50) NULL AFTER `type`;
...
UPDATE `exf_attribute` SET attribute_alias = 'TITLE', data = 'title' WHERE oid = 0x11e6c6a02e5cc79ba3e40205857feb80;