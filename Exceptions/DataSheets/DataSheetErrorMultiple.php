...
/**
 * Can combine any number of exceptions, grouping them by their messages to present a unified
 ...
 */
class DataSheetErrorMultiple extends UnexpectedValueException
{
     ...
     * @return void
     */
    public function merge(DataSheetErrorMultiple $other, bool $updateMessage = true) : void
    {
    ...
    /**
     * Get a list of error groups contained in this instance, to be used
     * as key parameters for many getters and setters of this instance.
     * 
     * @return array
     */
    public function getErrorGroups() : array
    {
        return array_keys($this->errorGroups);
    }
    ...
    public function getRowIndexes(): ?array
    {
        ...
        foreach ($this->getAllErrors() as $error) {
            if(!$error instanceof DataSheetValueExceptionInterface) {
                continue;
            }
