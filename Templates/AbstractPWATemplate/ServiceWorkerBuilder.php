...
JS;
    ...
    public function addRouteToCache(string $id, string $matcher, string $strategy, string $description = null, string $cacheName = null, int $maxEntries = null, int $maxAgeSeconds = null)
    {
