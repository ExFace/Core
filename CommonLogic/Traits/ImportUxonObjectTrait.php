...
trait ImportUxonObjectTrait {
	 ...
	 * @return void
	 */
	public function import_uxon_object(UxonObject $uxon, array $skip_property_names = array()){
		if (!$uxon) return;
		foreach ($uxon->get_properties_all() as $var => $val){
			...
			if (method_exists($this, $setterCamelCased)){
				call_user_func(array($this, $setterCamelCased), $val);
