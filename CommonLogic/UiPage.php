...
class UiPage implements UiPageInterface {
	 ...
	 * @throws UiWidgetConfigException
	...
	public function add_widget(WidgetInterface &$widget){
		...
		if ($widget->get_id_specified() && $widget->get_id_specified() != $this->sanitize_id($widget->get_id_specified())){
			throw new UiWidgetInvalidIdError('Explicitly specified id "' . $widget->get_id_specified() . '" for widget "' . $widget->get_widget_type() . '" not unique on page "' . $this->get_id() . '": please specify a unique id for the widget in the UXON description of the page!');
			return $this;
		}
