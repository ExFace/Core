...
abstract class AbstractAction implements ActionInterface {
	...
	final public function get_result_message(){
		...
		if ($this->get_result_message_text()){
			$message = '';
			$placeholders = $this->get_workbench()->utils()->find_placeholders_in_string($this->get_result_message_text());
			foreach ($this->get_result_data_sheet()->get_rows() as $row){
				$message_line = $this->get_result_message_text();
	 ...
	 * 
	 * {@inheritDoc}
	 * @see \exface\Core\Interfaces\Actions\ActionInterface::get_result_message_text()
	 */
	 ...
	 * @uxon-type string
	 * 
	 * @see \exface\Core\Interfaces\Actions\ActionInterface::set_result_message_text()
	 */
