...
class MetaModelInstaller extends DataInstaller
{
    ...
    public function __construct(SelectorInterface $selectorToInstall)
    {
        ...
        $this->addDataOfObject('exface.Core.PAGE_GROUP_PAGES', 'CREATED_ON', 'PAGE_GROUP__APP', [], 'Security/Page groups/[#=Transliterate(PAGE_GROUP__NAME, "' . $translitRule . '")#]/13_PAGE_GROUP_PAGES.json');
        ...
        $this->addDataOfObject('exface.Core.WIDGET_SETUP', 'CREATED_ON', 'APP');
    }
