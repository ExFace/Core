...
<div id="{$this->getId()}" class="exf-progressbar" style="width: calc(100% - 6px); padding: 0 3px; border:1px solid #ccc; position:relative; overflow: hidden; white-space:nowrap; color:transparent; {$style}" {$titleProp}>{$text}
