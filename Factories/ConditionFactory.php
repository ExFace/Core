...
abstract class ConditionFactory extends AbstractUxonFactory {
	 ...
	 * @param exface
	 * @param string|\exface\Core\Model\Expression $expression_or_string
	 * @param string $value
	 * @param string $comparator 
	 * @return Condition
	 */
	public static function create_from_expression(exface &$exface, Expression $expression=NULL, $value=NULL, $comparator=EXF_COMPARATOR_IS){
