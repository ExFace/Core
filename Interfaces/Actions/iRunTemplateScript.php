...
interface iRunTemplateScript {
	...
	/**
	 * Returns valid java script, that executes the action. The parameter $element_id contains the 
	 ...
	 */
	public function print_script($element_id);
	
	/**
	 * Returns java script code, that needs to be placed outside the actions script. Typically this will
